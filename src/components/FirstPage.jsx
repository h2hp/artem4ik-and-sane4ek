...
import kar from '../assets/gr1.png'
import line from '../assets/lin.svg'
...
const FirstPage = () => {
    return (
        ...
        <div className=' ' >
            <div className="flex">
                <div className="">
                    <div className=' absolut text-[56px] mt-70 ml-50 font-semibold '>
                ...
                <div className='-z-10 -mr-60'>
                    <img className='' src={kar} alt='' width={1200} ></img>
                </div>
            </div>
            <div className='absolut -z-10 -mt-170 '>
                <img src={line} alt='' width={3400}></img>
            </div>
        </div>
